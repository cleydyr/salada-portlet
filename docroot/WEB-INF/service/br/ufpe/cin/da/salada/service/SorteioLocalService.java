...
/**
 * Provides the local service interface for Sorteio. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author thecleydyr
 * @see SorteioLocalServiceUtil
...
public interface SorteioLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SorteioLocalServiceUtil} to access the sorteio local service. Add custom service methods to {@link br.ufpe.cin.da.salada.service.impl.SorteioLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
