...
<aui:button value="Criar sorteio"
...
<liferay-ui:search-container
	...
	<liferay-ui:search-container-results
		results="<%=SorteioLocalServiceUtil.getSorteios(
						searchContainer.getStart(), searchContainer.getEnd())%>"
		total="<%=SorteioLocalServiceUtil.getSorteiosCount()%>" />

	<liferay-ui:search-container-row
		className="br.ufpe.cin.da.salada.model.Sorteio" modelVar="aSorteio">

		<liferay-ui:search-container-column-text property="nome" name="Nome" />

		<liferay-ui:search-container-column-text property="dataAbertura"
			name="Data de Abertura" />

		<liferay-ui:search-container-column-text property="dataFechamento"
			name="Data de Fechamento" />

		<liferay-ui:search-container-column-jsp path="/sorteio/acoes.jsp"
			align="right" />
	</liferay-ui:search-container-row>
